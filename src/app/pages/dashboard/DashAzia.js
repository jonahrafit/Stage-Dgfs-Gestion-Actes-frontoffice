...
export class DashAzia extends Component {
  websiteAudienceChartData = {
    ...
    datasets: [{
      label: 'This week',
      data: [36.57, 38.9, 42.3, 41.8, 37.4, 32.5, 28.1, 28, 26, 20.4, 16.5, 12.1, 9.2, 5.1, 9.6, 10.8, 13.2, 18.2, 13.9, 18.7, 13.7, 11.3, 13.7, 15.8, 12.9, 17.5, 21.9, 18.2, 14.3, 18.2, 14.8, 13.01, 14.5, 15.4, 16.6, 19.4, 14.5, 17.7, 13.8, 9.4, 11.9, 9.7, 6.1, 1.4, 2.3, 2.3, 4.5, 3.7, 5.7, 5.08, 1.9, 8.2,
          ...
          <div className="az-content-body">
            ...
            <div className="az-dashboard-one-title">
              <div>
                ...
                {/* <p className="az-dashboard-text">On souhaite la bienvenu à vous</p> */}
              </div>
            ...
            <div className="az-dashboard-nav">
              ...
              <nav className="nav">
                <a className="nav-link" href="#/"><Icon.BsFile /> Rapport de garde </a>
                <a className="nav-link" href="#/"><Icon.BsHourglass /> Tableau de personnels</a>
                <a className="nav-link" href="#/"><Icon.BsPlusSquareFill /> Tableau des soins</a>
              ...
              <div className="col-lg-8 mg-t-20 mg-lg-t-0">
                <div className="card card-dashboard-four">
                  <div className="card-header">
                    <h6 className="card-title">Nombre selon le service </h6>
                  </div>{/* card-header */}
